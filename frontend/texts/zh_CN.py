...
# 侧边栏邮件报告
# ============================================================
SIDEBAR_EMAIL_SECTION = "邮件报告"
SIDEBAR_EMAIL_BUTTON = "发送当月报告"
SIDEBAR_EMAIL_SENDING = "正在发送邮件..."
SIDEBAR_EMAIL_SUCCESS = "邮件已发送！"
SIDEBAR_EMAIL_FAIL = "发送失败，请检查 .env 中的 SMTP 配置。"
SIDEBAR_EMAIL_NO_DATA = "当前月份无数据，无法发送报告。"

# ============================================================
# 数据采集区域（标的管理页面）
# ============================================================
COLLECT_SECTION = "数据采集"
COLLECT_SELECT_DATES = "选择要采集的月份"
COLLECT_BUTTON = "开始采集"
COLLECT_RUNNING = "正在采集数据，请稍候..."
COLLECT_SUCCESS = "采集完成！成功 {success} 个，跳过/失败 {skip} 个。"
COLLECT_NO_ASSETS = "请先添加标的后再进行数据采集。"
